...
#
# Script generated by Vivado on Tue Dec 03 20:05:08 +0800 2024
...
# script info
echo -e "block_ram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_ram xil_defaultlib.block_ram xil_defaultlib.glbl -log elaborate.log
}
