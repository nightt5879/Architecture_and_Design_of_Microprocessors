...
#
# Script generated by Vivado on Wed Dec 04 14:38:48 +0800 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/robot/project/Architecture_and_Design_of_Microprocessors/minicpu_env/soc_verify/run_vivado/project/loongson.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
